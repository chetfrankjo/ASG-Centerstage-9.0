            ...
            case BLUE_SOUTH:
                switch (spikePosition) {
                    case LEFT:
                        ...
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(29, 115, 0.5, 8, 0).addPoint(29, 102, 180).addPointSpeed(8, 108, 90, 0.3).build());
                                paths.add(new Trajectory(8, 110, 0.3, 8).addPoint(8, 115, 0).build());
                                break;
                            case RIGHT:
