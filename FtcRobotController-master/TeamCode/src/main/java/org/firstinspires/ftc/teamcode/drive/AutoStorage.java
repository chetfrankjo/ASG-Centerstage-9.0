        ...
        switch (allianceLocation) {
            case RED_SOUTH:
                switch (spikePosition) {
                    case LEFT:
                        paths.add(new Trajectory(135, 34, 0.4, 14, 0.1).addPoint(108, 34, 90).addPoint(108, 15, 180).build());
                        paths.add(new Trajectory(108, 15, 0.5, 13).addPoint(108, 11, 180).addPoint(81, 11, 90).addPoint(81, 108, 0).addPoint(101, 108, -90).addPoint(101, 116, 0).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(98, 115, 0.4, 8, 0.1).addPoint(98, 104, 180).addPointSpeed(81, 104, 90, 0.3).build());
                                paths.add(new Trajectory(81, 104, 0.3, 20).addPoint(81, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(98, 115, 0.4, 8, 0.1).addPoint(98, 104, 180).addPoint(130, 104, -90).build());
                                paths.add(new Trajectory(130, 104, 0.3, 20).addPoint(130, 115, 0).build());
                                break;
                        }
                        break;
                    case CENTER:
                        paths.add(new Trajectory(135, 34, 0.5, 16, 0.1).addPoint(99, 34, 90).addPoint(99, 24, 180).build());
                        paths.add(new Trajectory(99, 24, 0.5, 13).addPoint(99, 12, 180).addPoint(83, 12, 90).addPoint(83, 108, 0).addPoint(105, 108, -90).addPoint(105, 116, 0).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(105, 115, 0.4, 8, 0.1).addPoint(105, 104, 180).addPointSpeed(82, 104, 90, 0.3).build());
                                paths.add(new Trajectory(82, 104, 0.3, 20).addPoint(82, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(105, 115, 0.4, 8, 0.1).addPoint(105, 104, 180).addPoint(130, 104, -90).build());
                                paths.add(new Trajectory(130, 104, 0.3, 20).addPoint(130, 115, 0).build());
                                break;
                        }
                        break;
                    case RIGHT:
                        ...
                        paths.add(new Trajectory(106, 38, 0.5, 13).addPoint(106, 18, 180).addPoint(81, 18, 90).addPoint(81, 108, 0).addPoint(110, 108, -90).addPoint(110, 116, 0).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(110, 115, 0.4, 8, 0.1).addPoint(110, 104, 180).addPointSpeed(82, 104, 90, 0.3).build());
                                paths.add(new Trajectory(82, 104, 0.3, 20).addPoint(82, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(110, 115, 0.4, 8, 0.1).addPoint(110, 104, 180).addPoint(130, 104, -90).build());
                                paths.add(new Trajectory(130, 104, 0.3, 20).addPoint(130, 115, 0).build());
                                break;
                        }
                        break;
            ...
            case RED_NORTH:
                switch (spikePosition) {
                    case LEFT:
                        ...
                        paths.add(new Trajectory(107, 80, 0.6, 12).addPoint(107, 112, 0).addPoint(100, 112, 90).addPoint(100, 116, 0).build());
                        switch (parkLocation) {
                            case LEFT:
                    ...
                    case CENTER:
                        ...
                        paths.add(new Trajectory(97,91, 0.5, 12).addPoint(97, 100, 0).addPoint(106, 100, -90).addPoint(106, 116, 0).build());
                        switch (parkLocation) {
                            case LEFT:
                    ...
                    case RIGHT:
                        ...
                        paths.add(new Trajectory(100, 100, 0.6, 12).addPoint(100, 110, 0).addPoint(112, 110, -90).addPoint(112, 116, 0).build());
                        switch (parkLocation) {
                            case LEFT:
            ...
            case BLUE_SOUTH:
                switch (spikePosition) {
                    case LEFT:
                        ...
                        paths.add(new Trajectory(37, 38, 0.8, 13).addPoint(37, 26, 180).addPoint(63, 26, -90).addPoint(63, 105, 0).addPoint(30, 105, 90).build()); // 27
                        //paths.add(new Trajectory(63, 110, 0.5, 4).addPoint(30, 110, 90).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(29, 115, 0.5, 8, 0).addPoint(29, 102, 180).addPointSpeed(11, 108, 90, 0.3).build());
                                paths.add(new Trajectory(11, 110, 0.3, 8).addPoint(11, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(29, 115, 0.4, 8, 0).addPoint(29, 110, 180).addPoint(61, 110, -90).build());
                                paths.add(new Trajectory(61, 110, 0.3, 20).addPoint(61, 115, 0).build());
                                break;
                        }
                        break;
                    case CENTER:
                        paths.add(new Trajectory(9, 34, 0.5, 10).addPoint(100, 34, -90).addPoint(48.5, 27, 97.7).build()); //Start at start position, strafe east, back up a little bit
                        paths.add(new Trajectory(49, 30, 0.8, 13).addPoint(49, 20, 180).addPoint(63, 20, -90).addPoint(63, 130, 0).addPoint(63, 106, 0).addPoint(35, 106, 90).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(30, 115, 0.5, 8, 0).addPoint(30, 108, 180).addPointSpeed(11, 108, 90, 0.3).build());
                                paths.add(new Trajectory(11, 110, 0.3, 20).addPoint(11, 115, 0).build());
                                break;
                            case RIGHT:
                        ...
                        break;
                    case RIGHT:
                        paths.add(new Trajectory(9, 34, 0.5, 12, 0).addPoint(39, 34, -90).addPoint(39, 17, -180).build());
                        paths.add(new Trajectory(39, 15, 0.8, 15).addPoint(39, 10, 180).addPoint(63, 10, -90).addPoint(63, 106, 0).addPoint(37, 106, 90).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(35, 115, 0.5, 8, 0).addPoint(35, 110, 180).addPointSpeed(11, 110, 90, 0.3).build());
                                paths.add(new Trajectory(11, 110, 0.3, 20).addPoint(11, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(40, 115, 0.5, 12, 0).addPoint(40, 104, 180).addPoint(55, 104, -90).build());
                                paths.add(new Trajectory(55, 110, 0.3, 20).addPoint(55, 115, 0).build());
                                break;
                        }
                        break;
            ...
            case BLUE_NORTH:
                switch (spikePosition) {
                    case LEFT:
                        ...
                        paths.add(new Trajectory(37, 102, 0.4, 7).addPoint(31, 102, 90).addPoint(31, 116, 0).build());
                        switch (parkLocation) {
                            case LEFT:
                    ...
                    case CENTER:
                        ...
                        paths.add(new Trajectory(47, 94, 0.6, 12).addPoint(47, 110, 0).addPoint(37, 110, 90).addPoint(37, 116, 0).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(36, 115, 0.5, 8, 0.1).addPoint(36, 110, 180).addPointSpeed(10, 110, 90, 0.3).build());
                                paths.add(new Trajectory(10, 110, 0.3, 20).addPoint(10, 115, 0).build());
                                break;
                            case RIGHT:
                    ...
                    case RIGHT:
                        ...
                        paths.add(new Trajectory(38, 81, 0.6, 12).addPoint(38, 90, 0).addPoint(43, 90, -90).addPoint(43, 116, 0).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(43, 115, 0.5, 8, 0.1).addPoint(43, 104, 180).addPointSpeed(10, 104, 90, 0.3).build());
                                paths.add(new Trajectory(10, 104, 0.3, 20).addPoint(10, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(43, 115, 0.5, 8, 0.1).addPoint(43, 104, 180).addPoint(59, 104, -90).build());
