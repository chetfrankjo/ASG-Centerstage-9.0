    ...
    public static ArrayList<Trajectory> generateAutoPaths(General.ParkLocation parkLocation, General.SpikePosition spikePosition, General.AllianceLocation allianceLocation) {
        ...
        switch (allianceLocation) {
            case RED_SOUTH:
                switch (spikePosition) {
                    case LEFT:
                        ...
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(98, 122, 0.4, 6, 0.5).addPoint(98, 110, 180).addPointSpeed(81, 110, 90, 0.3).build());
                                paths.add(new Trajectory(84, 110, 0.3, 6, 0.5).addPoint(84, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(98, 122, 0.4, 6, 0.5).addPoint(98, 110, 180).addPoint(130, 110, -90).build());
                                paths.add(new Trajectory(130, 110, 0.3, 6, 0.5).addPoint(130, 115, 0).build());
                                break;
                        }
                        break;
                    case CENTER:
                        ...
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(105, 122, 0.4, 6, 0.5).addPoint(105, 110, 180).addPointSpeed(84, 110, 90, 0.3).build());
                                paths.add(new Trajectory(84, 110, 0.3, 6, 0.3).addPoint(84, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(105, 122, 0.4, 6, 0.5).addPoint(105, 110, 180).addPoint(130, 110, -90).build());
                                paths.add(new Trajectory(130, 110, 0.3, 6, 0.3).addPoint(130, 115, 0).build());
                                break;
                        }
                        break;
                    case RIGHT:
                        paths.add(new Trajectory(135, 34, 0.3, 4, 0.3).addPoint(108, 34, 90).addPoint(108, 37, 0).build());
                        paths.add(new Trajectory(106, 38, 0.5, 13, 0.3).addPoint(106, 20, 180).addPoint(81, 20, 90).addPoint(81, 106, 0).addPoint(110, 106, -90).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(112, 122, 0.5, 6, 0.1).addPoint(110, 110, 180).addPointSpeed(84, 110, 90, 0.3).build());
                                paths.add(new Trajectory(84, 110, 0.5, 6, 0.1).addPoint(84, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(112, 122, 0.5, 6, 0.1).addPoint(110, 110, 180).addPoint(130, 110, -90).build());
                                paths.add(new Trajectory(130, 110, 0.5, 6, 0.1).addPoint(130, 115, 0).build());
                                break;
                        }
                        break;
                }
            case RED_NORTH:
                switch (spikePosition) {
                    case LEFT:
                        paths.add(new Trajectory(135, 84, 0.3, 14, 0.5).addPoint(107, 84, 90).addPoint(107, 81, 180).build());
                        paths.add(new Trajectory(107, 81, 0.25, 12, 0.5).addPoint(107, 106, 0).addPoint(100, 106, 90).build()); //.addPoint(100, 105, 0)
                        switch (parkLocation) {
                            case LEFT:
                        ...
                        break;
                    case CENTER:
                        paths.add(new Trajectory(135, 84, 0.3, 12, 0.5).addPoint(97, 84, 90).addPoint(97, 91, 0).build());
                        paths.add(new Trajectory(97,91, 0.25, 12, 0.5).addPoint(97, 100, 0).addPoint(106, 100, -90).addPoint(106, 106, 0).build());
                        switch (parkLocation) {
                            case LEFT:
                        ...
                        break;
                    case RIGHT:
                        paths.add(new Trajectory(135, 84, 0.3, 12, 0.5).addPoint(135, 86, 0).addPoint(103, 86, 90).addPoint(103, 100, 0).build());
                        paths.add(new Trajectory(103, 100, 0.25, 6, 0.5).addPoint(103, 108, 0).addPoint(112, 108, -90).addPoint(112, 106, -180).build());
                        switch (parkLocation) {
                            case LEFT:
            ...
            case BLUE_SOUTH:
                switch (spikePosition) {
                    case LEFT:
                        ...
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(29, 115, 0.5, 4, 0.5).addPoint(29, 110, 180).addPointSpeed(11, 110, 90, 0.3).build());
                                paths.add(new Trajectory(11, 110, 0.3, 8).addPoint(11, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(29, 115, 0.4, 4, 0.5).addPoint(29, 110, 180).addPoint(61, 110, -90).build());
                    ...
                    case CENTER:
                        ...
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(31, 115, 0.5, 4, 0.5).addPoint(31, 110, 180).addPointSpeed(11, 110, 90, 0.3).build());
                                paths.add(new Trajectory(11, 110, 0.3, 20, 0.5).addPoint(11, 120, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(37, 115, 0.4, 4, 0.5).addPoint(37, 110, 180).addPoint(61, 110, -90).build());
                                paths.add(new Trajectory(61, 110, 0.3, 12, 0.5).addPoint(61, 120, 0).build());
                                break;
                        }
                        break;
                    case RIGHT:
                        paths.add(new Trajectory(9, 34, 0.3, 12, 0.8).addPoint(41.5, 34, -90).addPoint(41.5, 16, -180).build());
                        paths.add(new Trajectory(42, 16, 0.5, 12, 1.0).addPoint(42, 9, 180).addPoint(60, 9, -90).addPoint(60, 106, 0).addPoint(37, 106, 90).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(43, 122, 0.5, 4, 0.8).addPoint(43, 110, 180).addPointSpeed(12, 110, 90, 0.3).build());
                                paths.add(new Trajectory(12, 110, 0.3, 20).addPoint(12, 120, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(43, 115, 0.7, 4, 0.8).addPoint(43, 110, 180).addPoint(61, 110, -90).build());
                                paths.add(new Trajectory(61, 110, 0.5, 20).addPoint(61, 120, 0).build());
                                break;
                        }
                        break;
                }
            ...
            case BLUE_NORTH:
                switch (spikePosition) {
                    case LEFT:
                        paths.add(new Trajectory(9, 84, 0.4, 12, 0.5).addPoint(17, 84, -90).addPoint(17, 102, 0).addPoint(37, 102, -90).build());
                        paths.add(new Trajectory(37, 102, 0.3, 4, 0.5).addPoint(37, 112, 0).addPoint(34, 112, 90).addPoint(34, 106, 180).addPoint(31, 106, 90).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(29, 115, 0.3, 8, 0.5).addPoint(29, 110, 180).addPointSpeed(10, 110, 90, 0.3).build());
                                paths.add(new Trajectory(10, 110, 0.3, 20, 0.5).addPoint(10, 112, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(29, 115, 0.3, 8, 0.5).addPoint(29, 110, 180).addPoint(59, 110, -90).build());
                                paths.add(new Trajectory(59, 110, 0.3, 20, 0.5).addPoint(59, 115, 0).build());
                                break;
                        }
                        break;
                    case CENTER:
                        paths.add(new Trajectory(9, 84, 0.25, 12, 0.5).addPoint(9, 86, 0).addPoint(46, 86, -90).addPoint(46, 90, 0).build());
                        paths.add(new Trajectory(47, 90, 0.3, 12, 0.5).addPoint(47, 106, 0).addPoint(37, 106, 90).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(36, 115, 0.3, 12, 0.5).addPoint(36, 110, 180).addPointSpeed(12, 110, 90, 0.3).build());
                                paths.add(new Trajectory(12, 110, 0.3, 20, 0.5).addPoint(12, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(36, 115, 0.3, 8, 0.5).addPoint(36, 110, 180).addPoint(59, 110, -90).build());
                                paths.add(new Trajectory(59, 110, 0.3, 20, 0.5).addPoint(59, 115, 0).build());
                                break;
                        }
                        break;
                    case RIGHT:
                        paths.add(new Trajectory(9, 84, 0.25, 12, 0.5).addPoint(9, 86, 0).addPoint(38, 86, -90).addPoint(38, 81, 180).build());
                        paths.add(new Trajectory(38, 81, 0.3, 12, 0.5).addPoint(38, 90, 0).addPoint(43, 90, -90).addPoint(43, 106, 0).build());
                        switch (parkLocation) {
                            case LEFT:
                                paths.add(new Trajectory(43, 122, 0.3, 8, 0.5).addPoint(43, 104, 180).addPointSpeed(12, 104, 90, 0.3).build());
                                paths.add(new Trajectory(12, 104, 0.3, 20, 0.5).addPoint(12, 115, 0).build());
                                break;
                            case RIGHT:
                                paths.add(new Trajectory(43, 122, 0.3, 8, 0.5).addPoint(43, 104, 180).addPoint(59, 104, -90).build());
                                paths.add(new Trajectory(59, 104, 0.3, 20, 0.5).addPoint(59, 115, 0).build());
                                break;
                        }
                        break;
                }
