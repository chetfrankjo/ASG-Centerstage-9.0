        ...
        while (opModeIsActive()) {
            ...
            switch (autoState) {
                ...
                case VISION: // Read camera, no movement
                    ...
                    trajectories = AutoStorage.generateCycleAutoMorePaths(parkLocation, position, allianceLocation); // load up the paths
                    break;
                ...
                case CYCLE_INTAKE:
                    ...
                    if (result) {
                        ...
                        while ((timer.time() < 4 && !driver.getLeftHasPixel()) && !driver.getRightHasPixel() && opModeIsActive()) {
                            driver.drive(0, 0.1, 0, false); // drive backwards slowly to take in your pixel
                            driver.update();
                        }
                        timer.reset();
